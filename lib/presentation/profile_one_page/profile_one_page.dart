          ...
          try {
            ...
            if (response.isResultOk) {
              ...
              ScaffoldMessenger.of(context)
                  .showSnackBar(SnackBar(content: Text('updated Profile')));
              addAvatar(context);
            } else {
              print('Error uploading image: ${response.error}');
            }
              ...
              : Consumer<ProviderServices>(
                  builder: (_, provider, __) {
                    ...
                    final String avatarImagePath =
                        userInfo.avatar ?? ImageConstant.imgEllipse12;
                    ...
                    return SingleChildScrollView(
                      ...
                      child: Padding(
                        padding: EdgeInsets.only(
                            left: 15.h, right: 15.h, bottom: 225.v),
                        child: Column(
                          ...
                          children: [
                            ...
                            Align(
                              alignment: Alignment.center,
                              child: Text("${userInfo.emailAddress}",
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  ...
                                  Navigator.pushNamed(
                                      context,
                                      AppRoutes
                                          .profileScreen); // Replace with your actual route
                                },
                                child: _buildInfo(
                                  context,
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  ...
                                  Navigator.pushNamed(
                                      context,
                                      AppRoutes
                                          .eWalletScreen); // Replace with your actual route
                                },
                                child: Row(
                                  children: [
                                    CustomImageView(
                                      imagePath: ImageConstant
                                          .imgVuesaxLinearEmptyWallet,
                                      height: 20.adaptSize,
                                      width: 20.adaptSize,
                                    ),
                                    Padding(
                                      ...
                                      child: Text("E-wallet",
                                          style:
                                              CustomTextStyles.titleSmall15_1),
                                    ),
                                  ],
                                ),
                              ),
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  ...
                                  Navigator.pushNamed(
                                      context,
                                      AppRoutes
                                          .notificationOneScreen); // Replace with your actual route
                                },
                                child: Row(
                                  children: [
                                    CustomImageView(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  showModalBottomSheet(
                                    context: context,
                                    isScrollControlled:
                                        true, // Set to true for a full-screen modal
                                    builder: (BuildContext context) {
                                      return Container(
                                        height:
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Padding(
                                      padding:
                                          EdgeInsets.only(left: 19.h, top: 3.v),
                                      child: Text("Log Out",
                                          style:
                                              CustomTextStyles.titleSmall15_1),
                                    ),
                              ...
                              child: Row(
                                children: [
                                  Icon(
                                    Icons.phone,
                                    color:
                                        Colors.blue, // Choose a suitable color
                                    size: 20.adaptSize,
                                  ),
                                  Padding(
