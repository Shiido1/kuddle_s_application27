...
class FlightBookingWidget extends StatefulWidget {
  ...
  FlightBookingWidget({Key? key, required this.flight }) : super(key: key);
...
class _FlightBookingWidgetState extends State<FlightBookingWidget> {
  ...
  void onDataTicketFromChild(double totalTickets) {
    // Handle the data received from the child widget
          ...
          child: Column(
            ...
            children: [
              ...
              BookingDetailsCard(
                ...
                callticket: onDataTicketFromChild,
              ...
              CustomElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    print('final total is $finalTotalMade');
                    Navigator.push(context, MaterialPageRoute(builder: (builder) =>
                        PaymentChoiceScreen(finalPaymentMode: finalTotalMade.toDouble(),
                            ...
                            numberOfTickets: totalTickets.toString(),
                            ...
                            roomID:widget.flight.flightId.toString(),
                            itemID: widget.flight.flightId.toString(),
                            hostID: widget.flight.hostId.toString(),
...
class BookingDetailsCard extends StatefulWidget {
  ...
  final Function(double) callticket;
...
class _BookingDetailsCardState extends State<BookingDetailsCard> {
  ...
  void calculateTotalPrice() {
    ...
    totalFlightPrice = (widget.baseFlightPrice * numberOfDays * widget.adultCount) +
        (widget.childPrice * numberOfDays * widget.childrenCount) +
        (widget.infantPrice * numberOfDays * widget.childrenCount);
  ...
  Widget build(BuildContext context) {
    ...
    double totalPrice = (widget.baseFlightPrice * numberOfDays * widget.adultCount) +
        (widget.childPrice * numberOfDays * widget.childrenCount) +
        (widget.infantPrice * numberOfDays * widget.childrenCount);
    print("$totalPrice is here");
    widget.callticket(totalTickets.toDouble());
    ...
    return Card(
      ...
      child: Padding(
        padding: const EdgeInsets.all(16.0),
        child:  numberOfDays == 0 ? Text('Book to see details') : Column(
          ...
          children: [
            ...
            BookingDetailItem(title: 'Base Flight Price:', value: currencyFormatter.format(widget.costOfOneRoom)),
            BookingDetailItem(title: 'Total Price:', value: currencyFormatter.format(totalPrice)),
