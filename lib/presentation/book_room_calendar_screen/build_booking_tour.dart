...
import 'package:kuddle_s_application27/models/tour_response.dart';
import 'package:kuddle_s_application27/pages/home/model/tour_list_model/tour_model.dart';
...
class TourBookingWidget extends StatefulWidget {

  final TourModel vehicle;
  TourBookingWidget({Key? key, required this.vehicle }) : super(key: key);

  @override
  _TourBookingWidgetState createState() => _TourBookingWidgetState();
}



class _TourBookingWidgetState extends State<TourBookingWidget> {
  ...
  void addOrder(context) async {
    ...
    providerServices?.addOrder(
        map: {
          ...
          "hostID":4.toString(),
          "itemID": widget.vehicle.tourId.toString(),
          "itemType":"vehicle",
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (builder) =>
                        PaymentChoiceScreen(finalPaymentMode: finalTotalMade.toDouble(),
                            itemType: "tour", id: widget.vehicle.tourId.toString(),
                            checkInDate:departureDate.toString(),
                            checkInTime: departureTime.toString(),
                            checkOutDate :returningDate.toString(),
                            checkOutTime:returningTime.toString(),
                            hostID: widget.vehicle.hostId.toString(),
                            roomID:widget.vehicle.tourId.toString(),
                            itemID: widget.vehicle.tourId.toString(),
