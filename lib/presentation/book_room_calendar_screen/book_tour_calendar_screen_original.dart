...
class BookTourCalendarScreenOriginal extends StatefulWidget {
  final TourModel tour;
  BookTourCalendarScreenOriginal({Key? key, required this.tour }) : super(key: key);

  @override
  State<BookTourCalendarScreenOriginal> createState() => _BookTourCalendarScreenState();
}

class _BookTourCalendarScreenState extends State<BookTourCalendarScreenOriginal> {
  DateTime? rangeStart;
  ...
  void addOrder(context) async {
    ...
    providerServices?.addOrder(
        map: {
          ...
          "duration":"2",
          "hostID":4.toString(),
          "itemID": widget.tour.tourId.toString(),
          "itemType":"tour",
          "itemUnitPrice":widget.tour.price.toString(),
          "tickets":0.toString(),
          "userID":"$userId",
          "roomID": 1.toString(),
          "paymentStatus": "1",
  ...
  void initState() {
    ...
    var price = double.tryParse(widget.tour.price ?? '0.0') ?? 0.0;
    costOfOneRoom = price;
    _startPaystack();
  }
  @override
