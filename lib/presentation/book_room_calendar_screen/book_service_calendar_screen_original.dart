...
class BookServiceCalendarScreenOriginal extends StatefulWidget {
  final ServicesModel service;
  BookServiceCalendarScreenOriginal({Key? key, required this.service }) : super(key: key);

  @override
  State<BookServiceCalendarScreenOriginal> createState() => _BookServiceCalendarScreenState();
}

class _BookServiceCalendarScreenState extends State<BookServiceCalendarScreenOriginal> {
  DateTime? rangeStart;
  ...
  void addOrder(context) async {
    ...
    providerServices?.addOrder(
        map: {
          ...
          "duration":"2",
          "hostID":4.toString(),
          "itemID": widget.service.serviceId.toString(),
          "itemType":"service",
          "itemUnitPrice":widget.service.price.toString(),
          "tickets":0.toString(),
          "userID":"$userId",
          "roomID": 1.toString(),
          "paymentStatus": "1",
  ...
  void initState() {
    ...
    var price = double.tryParse(widget.service.price ?? '0.0') ?? 0.0;
    costOfOneRoom = price;
    _startPaystack();
  }
  @override
