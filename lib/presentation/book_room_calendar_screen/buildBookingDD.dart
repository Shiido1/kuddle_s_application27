...
class FlightBookingWidgetDD extends StatefulWidget {

  final FlightModel flight;
  FlightBookingWidgetDD({Key? key, required this.flight }) : super(key: key);
...
class _FlightBookingWidgetState extends State<FlightBookingWidgetDD> {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          ...
          // Make sure the initial value is one of the valid dropdown values
              ...
              CustomElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    _makePayment(totalPrice.toInt() * 10);
...
class _BookingDetailsCardState extends State<BookingDetailsCard> {
  ...
  Widget build(BuildContext context) {
    ...
    int totalPrice = widget.baseFlightPrice.toInt() * widget.adultCount + widget.childrenCount * widget.returningDate.difference(widget.departureDate).inDays ;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            BookingDetailItem(title: 'Base Flight Price:', value: '₦1,000,000'),
