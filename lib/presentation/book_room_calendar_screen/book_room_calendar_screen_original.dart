...
class BookRoomCalendarScreenOriginal extends StatefulWidget {
  final PropertyModel property;
  BookRoomCalendarScreenOriginal({Key? key, required this.property }) : super(key: key);

  @override
  State<BookRoomCalendarScreenOriginal> createState() => _BookRoomCalendarScreenState();
}

class _BookRoomCalendarScreenState extends State<BookRoomCalendarScreenOriginal> {
  DateTime? rangeStart;
...
var userId = await getAuthUserID();
    ...
    providerServices?.addOrder(
        map: {
          ...
          "duration":"2",
          "hostID":4.toString(),
          "itemID": widget.property.roomId.toString(),
          "itemType":"accommodation",
          "itemUnitPrice":widget.property.price.toString(),
          "tickets":0.toString(),
          "userID":"$userId",
          "roomID": widget.property.roomId.toString(),
          "paymentStatus": "1",
          "delivery_charge": 1500.toString()
        },
        context: context);
...
@override
  void initState() {
    ...
    var price = double.tryParse(widget.property.price ?? '0.0') ?? 0.0;
    costOfOneRoom = price;
    _startPaystack();
  }
  @override
