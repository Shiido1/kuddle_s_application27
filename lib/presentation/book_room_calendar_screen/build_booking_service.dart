...
class ServiceBookingWidget extends StatefulWidget {
  ...
  final ServicesModel vehicle;
  ServiceBookingWidget({Key? key, required this.vehicle }) : super(key: key);

  @override
  _ServiceBookingWidgetState createState() => _ServiceBookingWidgetState();
}
  ...
  void addOrder(context) async {
    ...
    providerServices?.addOrder(
        map: {
          ...
          "hostID":4.toString(),
          "itemID": widget.vehicle.serviceId.toString(),
          "itemType":"service",
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (builder) =>
                        PaymentChoiceScreen(
                            ...
                            itemType: "service",
                            id: widget.vehicle.serviceId.toString(),
                            checkInDate:departureDate.toString(),
                            checkInTime: departureTime.toString(),
                            checkOutDate :returningDate.toString(),
                            checkOutTime:returningTime.toString(),
                            ...
                            roomID:widget.vehicle.serviceId.toString(),
                            itemID: widget.vehicle.serviceId.toString(),
      ...
      child: Padding(
        ...
        child: numberOfDays == 0 ? Text('Select Booking') : Column(
          ...
          BookingDetailItem(
            ...
            BookingDetailItem(
              title: 'Base Service Booking Price:',
