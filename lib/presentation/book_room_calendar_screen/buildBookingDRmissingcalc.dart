...
class FlightBookingWidget extends StatefulWidget {
  ...
  final FlightModel vehicle;
  FlightBookingWidget({Key? key, required this.vehicle }) : super(key: key);
  ...
  void addOrder(context) async {
    ...
    providerServices?.addOrder(
        map: {
          ...
          "hostID":4.toString(),
          "itemID": widget.vehicle.flightId.toString(),
          "itemType":"flight",
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (builder) =>
                        PaymentChoiceScreen(finalPaymentMode: finalTotalMade.toDouble(),
                            itemType: "Flight", id: widget.vehicle.flightId.toString(),
      ...
      child: Padding(
        ...
        child: numberOfDays == 0 ? Text('Select Booking') : Column(
          ...
          children: [
            ...
            BookingDetailItem(
              title: 'Base Flight Booking Price:',
