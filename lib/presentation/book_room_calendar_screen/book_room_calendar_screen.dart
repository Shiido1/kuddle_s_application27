...
class BookRoomCalendarScreen extends StatefulWidget {
  BookRoomCalendarScreen({Key? key,}) : super(key: key);

  @override
  State<BookRoomCalendarScreen> createState() => _BookRoomCalendarScreenState();
}

class _BookRoomCalendarScreenState extends State<BookRoomCalendarScreen> {
  DateTime? rangeStart;
