...
class ViewBookingOneScreen extends StatelessWidget {
  const ViewBookingOneScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
            ...
            bottomNavigationBar: _buildContactHost(context)));
  }
  ...
  /// Section Widget
  Widget _buildContactHost(BuildContext context) {
    return CustomElevatedButton(
        text: "Contact Host",
        margin: EdgeInsets.only(left: 61.h, right: 61.h, bottom: 29.v),
        buttonStyle: CustomButtonStyles.fillPrimary,
        onPressed: () {
          onTapContactHost(context);
        });
  }
  ...
  onTapContactHost(BuildContext context) {
