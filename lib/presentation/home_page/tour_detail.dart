...
import 'package:kuddle_s_application27/presentation/book_room_calendar_screen/build_booking_tour.dart';
...
class _HotelDetailState extends State<TourDetail> {
  @override
                        ...
                        Container(
                          ...
                          child: RichText(
                            text: TextSpan(
                              children: [
                                TextSpan(
                                  text: "${widget.tour.aboutTourCenter} ",
                  ...
                  children: [
                    Row(children: [
                      ...
                      Padding(
                          ...
                          child: Text("${widget.tour.stateProvince}",
  ...
  Widget _buildBookNow(BuildContext context) {
    return CustomElevatedButton(
        ...
        onPressed: () {
          // BookTourCalendarScreenOriginal(tour: widget.tour)
          // BookTourCalendarScreenOriginal(tour: widget.tour)
          Navigator.push(
            context,
            MaterialPageRoute(
