...
import 'package:kuddle_s_application27/pages/home/model/vehicle_list_model/vehicle_model.dart';
import 'package:kuddle_s_application27/pages/home/model/vehicle_list_model/vehicle_model.dart';
...
import 'package:kuddle_s_application27/presentation/book_room_calendar_screen/build_booking_car.dart';
                        ...
                        Container(
                          ...
                          child: RichText(
                            text: TextSpan(
                              children: [
                                TextSpan(
                                  text: "${widget.vehicle.aboutVehicle} ",
                  ...
                  children: [
                    Row(children: [
                      ...
                      Padding(
                          ...
                          child: Text("${widget.vehicle.stateProvince}",
