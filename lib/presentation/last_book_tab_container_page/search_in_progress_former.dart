...
class SearchInProgressState extends State<SearchInProgress> with TickerProviderStateMixin {
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    ...
    String generateSearchPrompt(int index) {
      if (index >= 0 && index < chipNames.length) {
        String correctChipName = chipNames[index];
        return 'Search $correctChipName';
      } else {
    ...
    return CustomAppBar(
      ...
      title: AppbarTitle(
        text: generateSearchPrompt(widget.initialTabIndex),
  ...
  //         Expanded(
  //           child: Tab(
  //             child: Text("Accommodation", textAlign: TextAlign.center),
  //           ),
  //         ),
  //         Tab(child: Text("Cars")),
